<template>
  <div>
    ...
    <div v-else>
      <el-input-number v-if="!readerMode" v-model="_value" style="width: 100%;" :min="0" controls-position="right" :precision="precision" size="medium" clearable :placeholder="placeholder" />
      <div v-else v-text="_value" />
