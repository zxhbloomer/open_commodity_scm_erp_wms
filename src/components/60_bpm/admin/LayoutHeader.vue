<template>
  <div>
    <div class="header">
      ...
      <div class="publish">
        <el-button size="mini" @click="preview"><i class="el-icon-view" />预览</el-button>
        <el-button size="mini" type="primary" @click="publish"><i class="el-icon-s-promotion" />发布</el-button>
      </div>
      <div class="back">
        <el-button size="medium" icon="el-icon-arrow-left" circle @click="exit" />
        <span>
...
export default {
  ...
  methods: {
    ...
    check () {
      if (this.$store.getters.bpm_isEdit === null) {
