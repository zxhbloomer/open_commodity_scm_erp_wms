<template>
  <div ref="panel" class="from-panel">
    <div class="from-title">
      <el-button icon="el-icon-back" type="info" size="mini" circle plain style="margin-right: 15px" @click="$router.push('/')" />
      <span>流程面板</span>
      ...
      <div>
        ...
        <el-button icon="el-icon-plus" size="mini" @click="addGroup">新建分组</el-button>
      </div>
    </div>
    <draggable
      :list="groups"
        ...
        >
          ...
          >
            ...
            <div>
              ...
              <el-button v-if="item.isStop" type="text" icon="el-icon-delete" size="mini" @click="moveFrom(item)">删除
              </el-button>
...
// import {  getFormGroups, groupItemsSort,  getFormDetail, updateGroup, updateForm} from '@/api/design'
