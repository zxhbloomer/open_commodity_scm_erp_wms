<template>
  <div class="app-container">
    ...
    <el-button-group>
      ...
      <el-button
        v-permission="'P_LOGISTICS:SUBMIT'"
      ...
      >提交</el-button>
      <el-button
        v-permission="'P_LOGISTICS:AUDIT'"
      ...
      >审核</el-button>
      <el-button
        v-permission="'P_LOGISTICS:REJECT'"
      ...
      >驳回</el-button>
      <el-button
        v-permission="'P_LOGISTICS:FINISH'"
      ...
      >完成</el-button>
      <el-button
        v-permission="'P_LOGISTICS:ENABLE'"
      ...
      >查看</el-button>
      <el-button
        v-permission="'P_LOGISTICS:EXPORT'"
      ...
      >导出</el-button>
      <el-button
        v-permission="'P_LOGISTICS:UPDATE'"
      ...
      >修改</el-button>
      <el-button
        v-permission="'P_LOGISTICS:CANCEL'"
      ...
      >作废</el-button>
      <el-button
        v-permission="'P_LOGISTICS:DELETE'"
    ...
    >
      <div class="right">
        ...
        <span class="count-title">退货数量：</span><span class="count-data">{{ dataJson.sumData.count_return_qty == null?'0':dataJson.sumData.count_return_qty>0? isZhongLin ? formatNumber3(dataJson.sumData.count_return_qty) : formatNumber(dataJson.sumData.count_return_qty,true,4):0 }}</span>
      </div>
    </div>
    ...
    >
      ...
      >
        <template v-slot="scope">
          <a href="javascript:void(0)" @click="toReturnDetail(scope.row.type_name,scope.row.id,scope.row.code)">{{ scope.row.return_qty == null?0:scope.row.return_qty }}</a>
        </template>
      </el-table-column>
      <el-table-column
        sortable="custom"
...
export default {
  ...
  methods: {
    ...
    getDataList () {
      // 只查询 1物流订单, 2物流调度的物流单
      this.dataJson.searchForm.type_list = [constants_dict.DICT_B_SCHEDULE_STATUS_ONE, constants_dict.DICT_B_SCHEDULE_TYPE_TWO]
