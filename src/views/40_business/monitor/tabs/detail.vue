  ...
  <div class="app-container">
      ...
      >
        ...
        >
          ...
          <el-descriptions-item label="验车状态">
            {{ dataJson.tempJson.validate_vehicle == true?'验车通过':'验车失败' }}{{ dataJson.tempJson.validate_time == null?'':'('+formatDateTime(dataJson.tempJson.validate_time)+')' }}<br v-if="dataJson.tempJson.gps_time != null" class="br">
          ...
          <el-descriptions-item v-if="dataJson.tempJson.status !=='8'" />
        ...
        <div v-if="dataJson.tempJson.returnRelationVo!=null">
          ...
          >
            ...
            <el-descriptions-item label="退货数量">
              {{ dataJson.tempJson.returnRelationVo.quantity == null?'-': dataJson.tempJson.returnRelationVo.quantity }}
            </el-descriptions-item>
    ...
    >
      ...
      >
        ...
        >下一条<i class="el-icon-arrow-right el-icon--right" /></el-button>
        <el-button
          v-if="settings.showInAudit"
          v-permission="'P_MONITOR:IN_AUDIT'"
          type="primary"
          size="medium"
          :loading="settings.loading_next"
          @click="handleAudit()"
        >入库审核并跳转下一条</el-button>

        <el-button
          v-if="settings.showOutAudit"
          v-permission="'P_MONITOR:OUT_AUDIT'"
          type="primary"
          size="medium"
          :loading="settings.loading_next"
          @click="handleReturn()"
        >出库审核并跳转下一条</el-button>
...
export default {
  components: { TrackLog, ValidateLog, previewCard, previewVideoCard },
